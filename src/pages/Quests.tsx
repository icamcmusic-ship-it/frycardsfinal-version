...
import { Loader2, Target, CheckCircle2, Gift, Coins, Gem } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div>
        ...
        <p className="text-slate-600 font-bold mt-1">Complete long-term goals for epic rewards</p>
      </div>
      ...
      {activeQuests.length === 0 && completedQuests.length === 0 ? (
        <div className="text-center py-20 bg-[var(--surface)] border-4 border-[var(--border)] rounded-2xl shadow-[8px_8px_0px_0px_var(--border)]">
          ...
          <h3 className="text-2xl font-black text-[var(--text)] mb-2 uppercase">No Quests Available</h3>
          <p className="text-slate-600 font-bold">Check back later for new challenges!</p>
        </div>
      ) : (
        <div className="space-y-6">
          {activeQuests.length > 0 && (
            <div className="space-y-4">
              <h2 className="text-2xl font-black uppercase text-[var(--text)]">Active Quests</h2>
              <div className="grid gap-4">
          ...
          {completedQuests.length > 0 && (
            <div className="space-y-4 pt-8">
              <h2 className="text-2xl font-black uppercase text-slate-400">Completed Quests</h2>
